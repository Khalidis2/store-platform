...
const REQUIRED_COLUMNS = [
  ["stores", "notification_email"], ["stores", "status"], ["stores", "shipping_flat_cents"], ["stores", "free_shipping_threshold_cents"],
