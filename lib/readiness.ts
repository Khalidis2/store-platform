...
const REQUIRED_TABLES = ["stores","products","orders","discounts","discount_redemptions","platform_admins","audit_log","webhook_events","email_outbox","rate_limits"] as const;
