...
const REQUIRED_COLUMNS = [
  ...
  ["products", "status"], ["products", "low_stock_alerted_at"], ["orders", "public_token"], ["orders", "subtotal_cents"], ["orders", "shipping_cents"], ["orders", "refunded_amount_cents"], ["orders", "has_shipped"], ["orders", "paid_at"], ["orders", "platform_fee_percent_snapshot"], ["orders", "platform_fee_cents"],
] as const;
