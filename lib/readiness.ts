...
const REQUIRED_COLUMNS = [
  ...
  ["products","status"],["products","low_stock_alerted_at"],["orders","public_token"],["orders","subtotal_cents"],["orders","discount_id"],["orders","discount_code"],["orders","discount_type"],["orders","discount_value"],["orders","discount_cents"],["orders","shipping_cents"],["orders","refunded_amount_cents"],["orders","has_shipped"],["orders","paid_at"],["orders","platform_fee_percent_snapshot"],["orders","platform_fee_cents"],["webhook_events","processing_started_at"],["email_outbox","dedupe_key"],["email_outbox","processing_started_at"],["email_outbox","next_attempt_at"],
] as const;
