...
export default async function AuditLogPage() {
  ...
  return (
    <main>
      <h1>Activity log</h1>
      <p style={{ color: "#666" }}>
        Refunds, product deletions, and platform fee changes on this store — including actions
        taken by the platform admin, not just you.
      </p>
        ...
        <tbody>
          {entries.map((e) => (
            <tr key={e.id} style={{ borderBottom: "1px solid #eee" }}>
              <td style={{ whiteSpace: "nowrap", color: "#666", fontSize: "0.9rem" }}>
